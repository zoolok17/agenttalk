...
permits the rollover but makes the old-epoch result closed. A pre-frontier epoch
...
retry. It also specifies the closed stale-epoch result when rollover races an
...
declared terms consistently. Q4 is **SPECIFIED;
IMPLEMENTATION BLOCKED ON #115,
...
sweep, not a fresh open sweep. It may
accept the specified contract and blocking decomposition; it cannot approve
