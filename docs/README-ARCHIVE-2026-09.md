# README archive (superseded 2026-09)

> **Superseded.** This is the pre-rewrite README.md, kept for reference.
> The current README covers the same ground in a shorter, platform-oriented
> structure. If something here isn't in the new README and you believe it
> should be, open an issue rather than relying on this archive as current
> documentation — it is not maintained going forward.
...
Start with [docs/AGENTTALK-NEW-USER-MANUAL.md](AGENTTALK-NEW-USER-MANUAL.md)
for a concept-first onboarding manual. A generated PDF is available at
[docs/AGENTTALK-NEW-USER-MANUAL.pdf](AGENTTALK-NEW-USER-MANUAL.pdf).
For operator-facing procedures and examples, use
[docs/USER-MANUAL.md](USER-MANUAL.md). The other canonical docs are:

- [docs/AGENT-MANUAL.md](AGENT-MANUAL.md) - role-keyed operating guide
  for agents.
- [docs/DESIGN.md](DESIGN.md) - architecture, rationale, and decision
  history.
- [docs/ROADMAP.md](ROADMAP.md) - product roadmap.
- [docs/ASSURANCE.md](ASSURANCE.md) - release attestation and gate
  evidence.
- [docs/ISSUES.md](ISSUES.md) - living tracker.
- [docs/QWEN-OVH-TRIAL.md](QWEN-OVH-TRIAL.md) - operator runbook for
...
command. See the [development gate reference](DEV-GATE.md) for CI-leg,
...
> **Full walkthrough: [docs/supervisor-tutorial.md](supervisor-tutorial.md)** —
