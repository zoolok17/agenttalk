...
_DEFAULT_RULES = (
    ...
    "\n"
    "LONG-RUNNING WORK: if this message needs real time (a long test bar, polling "
    "CI, a multi-step build), do NOT post an interim status via the reply command - "
    "sending a reply is how you tell yourself the message is answered, and you will "
    "then stop, killing any of THIS turn's own background work still running. "
    "Instead run `& \"$env:AGENTTALK_PY\" -m agenttalk progress --to-id <id> -m "
    "'...'` as many times as useful. This does NOT end your turn, does NOT close or "
    "advance anything, and does NOT mean you are done - keep working. Only your "
    "final reply ends your turn.\n"
    "\n"
