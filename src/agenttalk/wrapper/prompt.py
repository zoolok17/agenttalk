...
_DEFAULT_RULES = (
    ...
    "arrives while you work. DO NOT re-read the agenttalk-listen skill or load any "
    "other skill - everything you need is below.\n"
    "\n"
    ...
    "request_id); if approved, say 'no blocking findings'.\n"
    ...
    "deploy / delete), run agenttalk check --for <you> --to-request <id> FIRST: "
    "exit 3 = the request was RESCINDED, hard-stop and do not act; only exit 0 "
    "clears you.\n"
    "\n"
