...
```powershell
python -m pip install "git+https://github.com/zoolok17/agenttalk.git@v0.91.1"
agenttalk install-skills          # installs bus skills + the dev-discipline devkit
```

Pin to a released tag (`@v0.91.1` above, or whatever the current
...
`CHANGELOG.md`. Install a specific tag (`@v0.91.1`, or whatever the
