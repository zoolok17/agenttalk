...
- **The supervisor is an external monitor, not a daemon.** `agenttalk
  ...
  `supervisor.ps1` uses an internal OS-bound executable poll and does the
  launching/relaunching/scoped-killing. The bus stays just files.
